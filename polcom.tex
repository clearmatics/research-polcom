...
\markulf{0209}{Why? Is there a direction? Do you mean A vectored Haux SE polynomial commitment scheme is vectored SE? I suspect that is the case and easy to prove, but why do we need it?}
...
\begin{itemize}
      ...
      \item Compute evaluations $\p{S_{\sigma 1}}(\chz)$,
        ...
        \michals{30.08}{Why not computing them honestly?}\markulf{02.09}{Probably a good idea for fixed polynomials. In fact, we probably have to do it this way.}
