...
\[
  \Pr \left[
    \begin{aligned}
      & \p{f_1}, \ldots, \p{f_k} = \ext_\adv(\srs, (c_1, \ldots, c_k), r),\\
      & c_i = \com(\srs, \p{f_i}),\\
    ...
    \begin{aligned}
      ...
      & \qquad \qquad (o_1, \ldots, o_k)) \gets \adv^{\oracles}(\srs, r), \\
    \end{aligned}
  \right.\right]
  \geq 1 - \eps(\secpar).
\]
...
$\ext_{\bdv}(\srs_{\PCOM}, \qbdv,
  ...
  To show that the extractor works, we describe two reduction in the AGM. One breaks the binding property of the polynomial commitment scheme, the other the soundness of the PHP.
