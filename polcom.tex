...
%  \item answers $\adv$, $\bdv$ queries to the random oracle by simulating it.
  ...
  \comment{ These commitments are output by $\cdv$. Since $\cdv$ is algebraic,
    ...
    \ncase{Game 4} \michals{20.08}{Add condition: adversary looses if the
      extracted polynomials contain the witness} In this game we consider a PHP
