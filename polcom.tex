...
X^{2\noofc}$, for $i \in \range{1}{3}$.
  ...
  \begin{align*}
    & \p{W_\chz^{t_1}}(X) = \PCOM.\open(\srs, \cp{t_{lo, 1}}(X) + \chz^\noofc \cp{t_{mid, 1}}(X) + \chz^{2 \noofc}
      \cp{t_{hi, 1}}(X), \p{t_1}(\chz)) \\
    & \p{W_\chz^{t_2}}(X) = \PCOM.\open(\srs, \cp{t_{lo, 2}}(X) + \chz^\noofc \cp{t_{mid, 2}}(X) + \chz^{2 \noofc}
      \cp{t_{hi, 2}}(X), \p{t_2}(\chz)), \\
    & \p{W_\chz^{t_3}}(X) = \PCOM.\open(\srs, \cp{t_{lo, 3}}(X) + \chz^\noofc \cp{t_{mid, 3}}(X) + \chz^{2 \noofc}
      \cp{t_{hi, 3}}(X), \p{t_3}(\chz)), \\
    & \p{W_\chz^{\p{r}}}(X) = \PCOM.\open(\srs, \cp{r}(X), \p{r}(\chz)), \\
    & \p{W_\chz^{\p{a}}}(X) = \PCOM.\open(\srs, \cp{a}(X), \p{a}(\chz)), \\
    & \p{W_\chz^{\p{b}}}(X) = \PCOM.\open(\srs, \p{b}(X), \p{b}(\chz)), \\
    & \p{W_\chz^{\p{c}}}(X) = \PCOM.\open(\srs, \p{c}(X), \p{c}(\chz)), \\
    & \p{W_\chz^{\p{S_{\sigma 1}}}}(X) = \PCOM.\open(\srs, \p{S_{\sigma 1}}(X), \p{S_{\sigma 1}}(\chz)), \\
    & \p{W_\chz^{\p{S_{\sigma 2}}}}(X) = \PCOM.\open(\srs, \p{S_{\sigma 2}}(X), 
      \p{S_{\sigma 2}}(\chz)), \\
    & \p{W_{\chz}^{\p{z}}}(X) = \PCOM.\open(\srs, \p{z}(X), \p{z}(\chz)) \\
    & \p{W_{\chz \omega}^{\p{z}}}(X) = \PCOM.\open(\srs, \p{z}(X), \p{z}(\chz \omega))
 \end{align*}
...
\begin{enumerate}
 ...
 polynomial commitment scheme.
  ...
  \begin{theorem}
    Let $\PCOM$ be a simulation-extractable polynomial commitment, then
