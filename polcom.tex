...
\begin{enumerate}
 ...
 polynomial commitment scheme.
  ...
  \end{theorem}
  \begin{proof}
    Let $\adv$ be a SE adversary for $\plonkprotfs^{\kzg}$ and $\bdv$ be a
    SE-PCOM adversary. We show how to use extractor $\ext_\bdv$ to build
    extractor $\ext_\adv$, which given $\adv$'s randomness, its code, and
    instance $\inp$ and proof its produces, outputs witness $\wit$ such that
    $\REL(\inp, \wit)$.
