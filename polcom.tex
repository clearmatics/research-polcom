...
\subsubsection{The idealised proof system}
  ...
  $\p{p}_{i', j'} (\vec{X}, \vec{B})$ has non-zero coefficient next to $B_i$ while for
  ...
  \emph{determined}. Importantly, polynomials in $D$ depends only
  \begin{itemize}
  \item on the current transcript, i.e.~
  \end{itemize}
